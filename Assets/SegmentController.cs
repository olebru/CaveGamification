...
public struct HeadingDistanceElevation
{
    public float headingDegrees;
    public float distance;
    public float elevation;
    public bool isGap;
    public string EndsAtJunctionID;
    public float up;
    public float down;
    public float left;
    public float right;
...
public class SegmentController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 0, distance = 2, elevation = 0 });

        //stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 25, distance = 3, elevation = 1 });
        //stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 35, distance = 1, elevation = 0, EndsAtJunctionID = "TheT" });
        //stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 60, distance = 4, elevation = 2 });
        // stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 0.0f, distance = 0.0f, elevation = 0.0f });
        // stickMapData.Clear();

        // stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 100, distance = 2, elevation = 1 });
        // renderer.PlotLeg(stickMapData, Color.white, "TheT");
        ...
        renderer.PlotLeg(stickMapData, Color.yellow);
        #endregion

        stickMapData.Clear();

        stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 45, distance = 2, elevation = 1 });
        stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 90, distance = 2, elevation = 1 });
        stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 135, distance = 2, elevation = 1 });
        stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 180, distance = 2, elevation = 1 });
        stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 225, distance = 2, elevation = 1 });
        stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 270, distance = 2, elevation = 1 });
        stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 315, distance = 2, elevation = 1 });
        stickMapData.Add(new HeadingDistanceElevation { headingDegrees = 360, distance = 2, elevation = 1 });
